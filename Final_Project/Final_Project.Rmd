...
In this stock analysis and comparison we will be looking at two long time rivals. Apple and Microsoft are members of the Dow Jones, an index which represents the top 30 companies in the United States of America. For our analysis we will be using the year 2017 as a reference and also make predictions for the stock price. Also in order to help evaluate each company we will the P/E Ratio, PB Ratio, EPS(Earnings-per-share), and Current Ratio.
...
After downloading the financial statements we will also need to obtain Apple's stock price, in order to calculate the P/E Ratio and the EPS. 
